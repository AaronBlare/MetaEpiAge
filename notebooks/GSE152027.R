...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE152027"
setwd(path_work)
...
betas <- read.csv(paste(path_data,"/GSE152027_IOP_processed_signals.csv", sep=""))
