...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE147221"
setwd(path_work)
...
pd$sentrixids <- paste0('X', sentrixids$title_1)
row.names(pd) <- pd$sentrixids

betas <- as.data.frame(read.csv(paste(path_data,"/GSE147221_Dublin_blood_processed_signals.csv", sep="")))
