...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE72773"
setwd(path_work)
...
betas <- as.data.frame(read.csv(paste(path_data,"/GSE72773_datBetaNormalized.csv", sep="")))
rownames(betas) <- betas$ID
