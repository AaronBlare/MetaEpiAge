...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL13534/GSE116379/raw"
...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE116379"
setwd(path_work)
...
pd$sentrixids <- gsub("-",".", as.character(sentrixids$title_1))
row.names(pd) <- pd$sentrixids
betas <- as.data.frame(read.csv(paste(path_data,"/GSE116379_CHINFAM_Matrix_processed_betas.csv", sep="")))
