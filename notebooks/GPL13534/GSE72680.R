...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL13534/GSE72680/raw"
...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE72680"
setwd(path_work)
...
row.names(pd) <-  paste0('X', sentrixids$description_2)

betas <- as.data.frame(read.table(paste(path_data,"/GSE72680_beta_values.txt", sep=""), header=TRUE, sep='\t'))
