...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL13534/GSE59250/raw"
...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE59250"
setwd(path_work)
...
row.names(pd) <-  paste0(pd$title, '.AVG_Beta')
betas <- as.data.frame(read.table(paste(path_data,"/GSE59250_average_betas.txt", sep=""), header=TRUE))
