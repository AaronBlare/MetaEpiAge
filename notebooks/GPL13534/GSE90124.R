...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL13534/GSE90124/raw"
path_horvath <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge"
path_harm_ref <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE90124/"
path_pc_clocks <- "D:/YandexDisk/Work/pydnameth/datasets/lists/cpgs/PC_clocks/"
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE90124"
setwd(path_work)
...
row.names(pd) <- gsub("SAMPLE","sample", as.character(pd$description))

betas <- as.data.frame(read.table(paste(path_data,"/GSE90124_betasProcessed_Non-normalisedValues_322samples_2016.txt", sep=""), header=TRUE))
