...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL13534/GSE74414/raw"
...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE74414"
setwd(path_work)
...
row.names(pd) <- pd$gsm
betas <- as.data.frame(read.table(paste(path_data,"/GSE74414_all_beta_values.txt", sep=""), header=TRUE))
