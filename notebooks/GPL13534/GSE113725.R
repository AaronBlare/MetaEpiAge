...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL13534/GSE113725/raw"
...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE113725"
setwd(path_work)
...
betas <- as.data.frame(read.csv(paste(path_data,"/GSE113725_rawBetas.csv", sep="")))
