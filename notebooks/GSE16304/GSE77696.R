...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL16304/GSE77696/raw"
...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL16304/GSE77696"
setwd(path_work)
...
betas <- as.data.frame(read.table(paste(path_data,"/GSE77696_MatrixProcessed.txt", sep=""), header=TRUE, sep='\t'))
