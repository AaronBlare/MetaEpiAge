...
path_work <- "D:/YandexDisk/Work/pydnameth/draft/10_MetaEPIClock/MetaEpiAge/GPL13534/GSE56105"
setwd(path_work)
...
betas <- as.data.frame(read.table(paste(path_data,"/GSE56105_average_beta.txt", sep=""), header=TRUE, sep='\t'))
